...
Times are in seconds rather than frames, on the recording's own clock. The
input's timeline offset and shifts place them on the shared experiment timeline.
Turns by different speakers may overlap: that is how simultaneous speech is
represented.
