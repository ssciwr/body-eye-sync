...
#: The smallest clock-rate difference worth correcting. Measured against real
#: recordings: a glasses camera known to agree with the reference camera still
#: fitted 24.8 ppm, so the floor sits above what a recording that kept time can
#: produce rather than at the edge of it.
MIN_DRIFT_PPM = 30.0
...
class TimingCorrectionAnalysis:
    ...
    #: Inputs that came back without a correction: either they carry no audio
    #: to measure, or none of it could be placed against the reference.
